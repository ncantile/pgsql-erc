...
--all the data below refer to the db the client is connected to, each schema should be analyzed independently
...
--this query returns the size of the all the objects in the schema
